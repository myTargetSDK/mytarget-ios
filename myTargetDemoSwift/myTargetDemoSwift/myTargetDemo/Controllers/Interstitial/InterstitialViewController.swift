    ...
    override func viewDidLayoutSubviews() {
        ...
        if slotId == nil {
            ...
            loadButton.frame = CGRect(x: safeAreaInsets.left + buttonInsets.left,
                                      ...
                                      width: view.bounds.width - safeAreaInsets.left - safeAreaInsets.right - buttonInsets.left - buttonInsets.right,
                                      height: buttonHeight)
            ...
            loadButton.frame = CGRect(x: safeAreaInsets.left + buttonInsets.left,
                                      ...
                                      width: view.bounds.width - buttonInsets.left - buttonInsets.right - safeAreaInsets.left - safeAreaInsets.right,
                                      height: buttonHeight)
            showButton.frame = CGRect(x: safeAreaInsets.left + buttonInsets.left,
